...
# download/install MongoDB PGP keys
	export GNUPGHOME="$(mktemp -d)"; \
	wget -O KEYS 'https://pgp.mongodb.com/server-4.4.asc'; \
	gpg --batch --import KEYS; \
	mkdir -p /etc/apt/keyrings; \
	gpg --batch --export --armor '20691EEC35216C63CAF66CE1656408E390CFB1F5' > /etc/apt/keyrings/mongodb.asc; \
	gpgconf --kill all; \
...
ENV MONGO_VERSION 4.4.30
# 12/18/2025, https://github.com/mongodb/mongo/tree/4d7fa6a6260d25c5caa971dce10561690cb79dea
